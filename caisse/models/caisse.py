...
class ReportVentes(models.AbstractModel):
    ...
    def get_ventes(self, date_start=False, date_stop=False):
        ...
        cr = self.env.cr
        #location = location[0]
        requete = "SELECT p.barcode, pr.name as produit, l.qty as quantite, i.value_float as prixrevient, l.price_unit as prixvente, l.price_unit-i.value_float as margeunit, (l.price_unit-i.value_float)*l.qty as margetot, l.qty*l.price_unit as ventetot " \
